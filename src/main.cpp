...
// Chassis
pros::MotorGroup left_mg({2, -4, 9});    // Creates a motor group with forwards ports 1 & 3 and reversed port 2
pros::MotorGroup right_mg({3, -5, -10});  // Creates a motor group with forwards port 5 and reversed ports 4 & 6
// drivetrain settings
...
void opcontrol() {
	// pros::Controller master(pros::E_CONTROLLER_MASTER);
	// pros::MotorGroup left_mg({9, 10});    // Creates a motor group with forwards ports 1 & 3 and reversed port 2
	// pros::MotorGroup right_mg({-1, -2});  // Creates a motor group with forwards port 5 and reversed ports 4 & 6
